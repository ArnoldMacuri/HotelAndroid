...
@Stable
data class HotelColorSchema(

    //Main
    val primario1: Color = Color(0xFF1AB65C),
    val primario2: Color = Color(0xFF48C57D),
    val primario3: Color = Color(0xFF76D39D),
    val primario4: Color = Color(0xFFA3E2BE),
    val primario5: Color = Color(0xFFE8F8EF),

    val secundario1: Color = Color(0xFFFFD300),
    val secundario2: Color = Color(0xFFFFDC33),
    val secundario3: Color = Color(0xFFFFE566),
    val secundario4: Color = Color(0xFFFFED99),
    val secundario5: Color = Color(0xFFFFFBE6),
...
val hotelColorSchema = HotelColorSchema()
val LocalHotelColorSchema = staticCompositionLocalOf { hotelColorSchema }
